...
- An optional reading of OMEGA decisions tagged with each project name from the prior week, if available — recent OMEGA activity is a tiebreaker when two projects look equally needle-moving from the notes alone.
