*Expanded from [README §How this compares](../README.md#how-this-compares).*
...
For the directory map of what's actually shipped here, see [whats-inside.md](whats-inside.md). For the rationale on the single-harness scope above, see [why-only-claude-code.md](why-only-claude-code.md).
